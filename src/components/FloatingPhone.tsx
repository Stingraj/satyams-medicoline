...
export default function FloatingPhone() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 w-12 h-12 bg-[#C0392B] text-white rounded-full shadow-lg hover:bg-[#C0392B] hover:shadow-xl transition-all duration-200 flex items-center justify-center group"
    >
